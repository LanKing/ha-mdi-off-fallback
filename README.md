...
**Примечание:** Внутренние интерфейсные компоненты Home Assistant не являются стабильным публичным API. При обновлениях интерфейса HA могут потребовать обновления плагина.
