...
🚀 [Pokušajte da dodate repozitorijum preko ovog linka](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Ako je ovaj način podržan u vašem HA i radi, kliknite **Add** u otvorenom prozoru, a zatim **Download** dole desno. Ako je sve uspelo, instalacija je završena i preostale korake možete preskočiti. Idite direktno na [Konfiguracija](#configuration).
