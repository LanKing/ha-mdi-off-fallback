...
🚀 [Provoni ta shtoni repozitorin përmes kësaj lidhjeje](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Nëse kjo mënyrë mbështetet nga HA juaj dhe funksionon, klikoni **Add** në dritaren që hapet dhe më pas **Download** poshtë djathtas. Nëse gjithçka përfundoi me sukses, instalimi ka mbaruar dhe mund t'i kapërceni hapat e mbetur. Shkoni drejtpërdrejt te [Konfigurimi](#configuration).
