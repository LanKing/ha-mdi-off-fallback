...
🚀 [Coba tambahkan repositori melalui tautan ini](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Jika cara ini didukung oleh HA Anda dan berhasil, klik **Add** pada jendela yang terbuka lalu **Download** di sudut kanan bawah. Jika semuanya berhasil, instalasi selesai dan langkah instalasi berikutnya dapat dilewati. Langsung buka [Konfigurasi](#configuration).
