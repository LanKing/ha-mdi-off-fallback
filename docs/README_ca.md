...
🚀 [Proveu d'afegir el repositori amb aquest enllaç](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Si aquest mode és compatible amb el vostre HA i funciona, feu clic a **Add** a la finestra que s'obre i després a **Download** a l'extrem inferior dret. Si tot ha anat bé, la instal·lació s'ha completat i podeu ometre la resta de passos. Aneu directament a [Configuració](#configuration).
