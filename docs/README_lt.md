...
🚀 [Pabandykite pridėti saugyklą naudodami šią nuorodą](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Jei šį būdą palaiko jūsų HA ir jis veikia, atsidariusiame lange spustelėkite **Add**, tada apatiniame dešiniajame kampe **Download**. Jei viskas pavyko, diegimas baigtas ir likusius diegimo veiksmus galite praleisti. Pereikite tiesiai į [Konfigūracija](#configuration).
