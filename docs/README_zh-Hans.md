...
🚀 [尝试通过此链接添加仓库](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin)。如果你的 HA 支持这种方式并且操作成功，请在打开的窗口中点击 **Add**，然后点击右下角的 **Download**。如果一切顺利，安装已经完成，可以跳过剩余安装步骤。直接前往 [配置](#configuration)。
