...
🚀 [Probéiert de Repository iwwer dëse Link derbäizesetzen](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Wann dëse Wee vun Ärem HA ënnerstëtzt gëtt a funktionéiert, klickt am opgaangene Fënster op **Add** an duerno ënnen riets op **Download**. Wann alles geklappt huet, ass d'Installatioun fäerdeg an déi reschtlech Schrëtt kënne iwwerspronge ginn. Gitt direkt op [Konfiguratioun](#configuration).
