...
🚀 [Prova ad aggiungere il repository tramite questo link](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Se questa modalità è supportata dal tuo HA e funziona, fai clic su **Add** nella finestra che si apre e poi su **Download** in basso a destra. Se tutto è andato a buon fine, l'installazione è completa e puoi saltare i passaggi rimanenti. Vai direttamente a [Configurazione](#configuration).
