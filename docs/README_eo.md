...
🚀 [Provu aldoni la deponejon per ĉi tiu ligilo](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Se ĉi tiu maniero estas subtenata en via HA kaj funkcias, alklaku **Add** en la malfermita fenestro kaj poste **Download** malsupre dekstre. Se ĉio sukcesis, la instalado estas finita kaj vi povas preterlasi la ceterajn instalajn paŝojn. Iru rekte al [Agordo](#configuration).
