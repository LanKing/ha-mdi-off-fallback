...
🚀 [Depoyu bu bağlantı üzerinden eklemeyi deneyin](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Bu yöntem HA'nız tarafından destekleniyor ve çalışıyorsa açılan pencerede **Add**, ardından sağ altta **Download** düğmesine tıklayın. Her şey başarılı olduysa kurulum tamamlanmıştır ve kalan kurulum adımlarını atlayabilirsiniz. Doğrudan [Yapılandırma](#configuration) bölümüne gidin.
