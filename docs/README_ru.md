...
Если такого фона нет, плагин добавляет бледный круг, совпадающий с оформлением стандартной неактивной Tile-иконки Home Assistant (это нужно для единства отображения иконок).
