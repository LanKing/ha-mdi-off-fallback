...
🚀 [Prøv å leggje til repositoryet via denne lenkja](https://my.home-assistant.io/redirect/hacs_repository/?owner=LanKing&repository=ha-mdi-off-fallback&category=plugin). Dersom denne metoden er støtta i HA-en din og fungerer, klikkar du **Add** i vindauget som opnar seg og deretter **Download** nede til høgre. Dersom alt gjekk bra, er installasjonen ferdig og du kan hoppe over resten av installasjonsstega. Gå direkte til [Konfigurasjon](#configuration).
